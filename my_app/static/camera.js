...
function displayErrorMessage(error_msg, error) {
  ...
  document
    .querySelector("#error_instructions")
    .addEventListener("click", function () {
      swal(
        "1. To the left of the web page address, click the Lock or Info icon \
